...
class changepass_buyer extends StatefulWidget {


  changepass_buyer({this.userid, this.Type, this.content, this.Name, this.signupid, this.previouspage});
...
class _LoginFormValidationState extends State<changepass_buyer> {
  ...
  Future<bool> _onBackPressed(){
    ...
    else if(widget.previouspage=="buyerdashboard")
    {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) =>
