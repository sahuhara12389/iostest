...
class editproducts extends StatefulWidget {
  ...
  editproducts({this.userid, this.Type, this.content, this.Name, this.signupid, this.returnProductID, this.returncategory, this.returntitle, this.returnimage, this.returndescription});
...
class _MyHomePageState extends State<editproducts> {
  ...
  List<Map> _myJsontitle = [{"id":'Select',"name":"Select"},{"id":'Active',"name":"Active"},{"id":'Inactive',"name":"Inactive"}];
  String _mySelection_title="Select";
  ...
  void initState() {
    ...
    producttitle.text= widget.returntitle.toString();
    productdesc.text= widget.returndescription.toString();
    _mySelection= widget.returncategory.toString();
          ...
          Align(
              ...
              Padding(
                  padding: const EdgeInsets.only(
                      left:25.0, right: 1.0, top: 0, bottom: 0),
                  child:
  ...
  Future uploadImageToServer(BuildContext context) async {
    ...
    try{
      ...
      var uri = Uri.parse('https://itpcchennai.com/web_api/public/edit_product');
      ...
      request.fields['property_status'] = _mySelection_title;
      request.fields['property_id'] = widget.returnProductID;
...
//                                ])
                      ...
                      Align(
                        ...
                        Padding(
                          ...
                          child:
                          Text('Product Status', style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal,decoration: TextDecoration.none, color: Colors.black,  fontFamily: 'Noto Sans'),),
                        ),
