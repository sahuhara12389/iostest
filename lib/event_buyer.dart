...
import 'package:itpcchennaiapp/eventsdetails_buyer.dart';
...
class event_buyer extends StatefulWidget {


  event_buyer({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<event_buyer> {
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          Padding(
                            ...
                            child:
                            Text('Events', style: TextStyle(fontSize: 18,fontWeight: FontWeight.normal,decoration: TextDecoration.none, color: Colors.black,  fontFamily: 'Noto Sans'),),
                          ),
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) =>
                                  eventdetails_buyer(
                                      userid:widget.userid ,Type:widget.Type,content:widget.content,Name:widget.Name,signupid:widget.signupid,eventid:"1"
                                  ...
                                  Align(
                                    ...
                                    child: Stack(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Center(
                                          child:Image.asset('images/indonesia.png',height: 100, width: 100,),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              left: 0.0, right: 0.0, top: 120, bottom: 0),
                                          child:
                                          Center(
                                            child: Text('Events in Indonesia', style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal,decoration: TextDecoration.none, color: Colors.black,  fontFamily: 'Noto Sans'),),
                                          ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) =>
                                  eventdetails_buyer(
                                      userid:widget.userid ,Type:widget.Type,content:widget.content,Name:widget.Name,signupid:widget.signupid,eventid:"2"
                                  ...
                                  Align(
                                    ...
                                    child: Stack(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Center(
                                          child:Image.asset('images/india.png',height: 100, width: 100,),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              left: 0.0, right: 0.0, top: 120, bottom: 0),
                                          child:
                                          Center(
                                            child: Text('Events in India', style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal,decoration: TextDecoration.none, color: Colors.black,  fontFamily: 'Noto Sans'),),
                                          ),
                                        ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) =>
                                  eventdetails_buyer(
                                      userid:widget.userid ,Type:widget.Type,content:widget.content,Name:widget.Name,signupid:widget.signupid,eventid:"3"
                                  ...
                                  Align(
                                    ...
                                    child: Stack(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Center(
                                          child:Image.asset('images/india_indonesia.jpg',height: 100, width: 100,),
                                        ),
                                        ...
                                        Padding(
                                          ...
                                          child:
                                          Center(
                                            child: Text('Events in ITPC', style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal,decoration: TextDecoration.none, color: Colors.black,  fontFamily: 'Noto Sans'),),
                                          ),
                                        ),
