...
class marketbriefindia extends StatefulWidget {


  marketbriefindia({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<marketbriefindia> {
