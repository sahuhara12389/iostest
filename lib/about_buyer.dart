...
class aboutus_buyer extends StatefulWidget {


  aboutus_buyer({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<aboutus_buyer> {
