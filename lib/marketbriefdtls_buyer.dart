...
class marketbriefdtlsbuyer extends StatefulWidget {

  marketbriefdtlsbuyer({this.userid, this.Type, this.content, this.Name, this.signupid,this.previouspage, this.Url});
...
class _MyHomePageState extends State<marketbriefdtlsbuyer> {
