...
class exportnewindonesaiadtls_buyer extends StatefulWidget {

  exportnewindonesaiadtls_buyer({this.userid, this.Type, this.content, this.Name, this.signupid,this.previouspage, this.Url});
...
class _MyHomePageState extends State<exportnewindonesaiadtls_buyer> {
