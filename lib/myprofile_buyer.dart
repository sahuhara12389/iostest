...
class myprofile_buyer extends StatefulWidget {


  myprofile_buyer({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<myprofile_buyer> {
