...
class exportnewindonesaiadtls extends StatefulWidget {

  exportnewindonesaiadtls({this.userid, this.Type, this.content, this.Name, this.signupid,this.previouspage, this.Url});
...
class _MyHomePageState extends State<exportnewindonesaiadtls> {
