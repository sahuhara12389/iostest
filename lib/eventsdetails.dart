...
class eventdetails extends StatefulWidget {
  ...
  eventdetails({this.userid, this.Type, this.content, this.Name, this.signupid, this.eventid});
...
class UserFilterDemoState extends State<eventdetails> {
...
//        ),
        ...
        appBar: AppBar(
          title: Text(pagetitle,style: TextStyle(fontSize: 20, color: Colors.black),
                  textAlign: TextAlign.left,),
