...
import 'package:itpcchennaiapp/exportnewindonesaiadtls_buyer.dart';
import 'package:itpcchennaiapp/exportnewindonesiadetails.dart';
...
class exportnewindonesia_buyer extends StatefulWidget {


  exportnewindonesia_buyer({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<exportnewindonesia_buyer> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child:
                      Text('Export News-Indonesia',style: const TextStyle(
                          color: Colors.black,
                          fontSize: 16.0,
                          fontWeight: FontWeight.normal,
                          fontFamily: 'Noto Sans'
