...
class contactus_buyer extends StatefulWidget {


  contactus_buyer({this.userid, this.Type, this.content, this.Name, this.signupid});
...
class UserFilterDemoState extends State<contactus_buyer> {
